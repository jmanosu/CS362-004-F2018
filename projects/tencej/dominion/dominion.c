...
int villageCard(struct gameState *, int, int);
int remodelCard(struct gameState *, int, int, int, int);
int baronCard(struct gameState *, int, int);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
      ...
      //needs struct gameState * state, int drawntreasure, int currentPlayer, int * temphand, int z
      return  adventurerCard(state, drawntreasure, currentPlayer, temphand, z);
...
int villageCard(struct gameState * state, int currentPlayer, int handPos){
  ...
  for(int i = 0; i < 3; i++){
    ...
    //+32 Actions
    state->numActions = state->numActions + 32;
